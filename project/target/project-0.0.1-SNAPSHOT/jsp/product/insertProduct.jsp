...
<div class="sc-50d6daba-2 cDorvW">
	<form action="insertProductProc" name="f" method='post'
				...
				<div class="regist_box">
					<div class="description">
						<dl class="sc-fd6dc0e2-0 gvDVXQ regist_image_dl" id="images_box">
							...
							<div class="sc-cc0f1f42-0 gVjVQf">
								<dt class="sc-cc0f1f42-1 gkrGGR">
									<label class="sc-cc0f1f42-2 hDhFxO">상품 이미지</label>
								</dt>
							</div>
								...
								<div role="presentation" tabindex="0">
									...
									<div class="form-group">
										<input class="form-control form-control-user" type="file"
											multiple="multiple" name="upFile" id="product_detail_image"
										...
										<div class="sc-fd6dc0e2-2 iFwSNh">
											<div class="sc-c2e8ea43-0 dLKbDW">
												<img
													...
													alt="중간 도트" class="sc-c2e8ea43-1 ctBiin" /> 클릭하여 이미지를 첨부할
												수 있습니다.
											</div>
										</div>
						...
						<dl class="regist_title" id="title">
							<label class="sc-cc0f1f42-2 hDhFxO"> <img
								src="https://ccimage.hellomarket.com/img/common/middle_dot.svg"
								alt="중간 도트" class="sc-c2e8ea43-1 ctBiin" /> 이미지 미리보기
							</label>
							<dd>
